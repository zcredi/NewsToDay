...
extension UIFont {
    ...
    //Regular
    static func interRegular14() -> UIFont? {
        return UIFont.init(name: "Inter-Regular", size: 14)
    }
    
    static func interRegular16() -> UIFont? {
    ...
    static func interMedium16() -> UIFont? {
        return UIFont.init(name: "Inter-Medium", size: 16)
    }
    
    //SemiBold
    static func interSemiBold12() -> UIFont? {
    ...
    //Bold
    static func interBold16() -> UIFont? {
